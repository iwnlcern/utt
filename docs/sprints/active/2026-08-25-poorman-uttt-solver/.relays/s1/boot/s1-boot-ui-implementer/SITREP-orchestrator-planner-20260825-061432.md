...
TO: ui.implementer
SUBJECT: BOOT — initialize ui.implementer for RUN_ID s1

## Boot

You are seat `ui.implementer` in RUN_ID s1: the Poorman auction-bidding ultimate tic-tac-toe solver sprint.
