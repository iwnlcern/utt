...
Revision: 10 (2026-08-27; folds engine-c4-design-review-9's single finding — the alternation memo's identity is now collision-safe (full semantic identity plus `h` plus remaining depth; hash for bucketing only) with a locked reuse rule and forced-collision acceptance evidence; rev 9 locked the dedicated G6 alternation solver; G1–G6 and all solved-scale exactness are unchanged)
