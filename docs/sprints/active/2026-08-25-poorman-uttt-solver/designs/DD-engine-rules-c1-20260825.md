...
Status: revision 5 (amendment 1), awaiting successor Implementer DESIGN-REVIEW of the amendment.
Revision 5 / amendment 1 (2026-08-25, per this DD's own §14 owner-amendment rule and PLAN-REVIEW `engine-c1-plan-review-7` MR7): the consumed harness owner digest in §6 and §12 is refreshed from superseded 11ac4efc8520d4baa306dbb4f7d902bbcfe5b5738afc1fd0a71941b3e7890440 to the approved amended DD-harness-c1-20260825 at c935c29c0ee603df1750c49c40dabcd5432f70105070b60552728f1e6dc24a6e (approving review `harness-c1-design-review-4`).
Harness amendment 1 changes only harness-owned recovery-event association and single-fault recovery/log ordering; it leaves the five engine-facing message shapes, every adapter obligation, all acceptance criteria, and the engine scope of this document unchanged, and its recovery/log semantics remain harness-owned and out of engine scope.
No other byte of this design changes in revision 5.
...
The owner schema is design-locked and this section consumes it AS-IS: DD-harness-c1-20260825, Implementer-APPROVED at digest c935c29c0ee603df1750c49c40dabcd5432f70105070b60552728f1e6dc24a6e (amendment 1 included; approving review `harness-c1-design-review-4`; originally locked at superseded digest 11ac4efc85…7890440 via `.relays/s1/harness-c1/DESIGN-REVIEW-pair-implementer-20260825-081315.md` — refreshed by this DD's amendment 1 per §14), routed to this consumer by the addressed orchestrator alignment relay `.relays/s1/engine-c1/SITREP-orchestrator-planner-20260825-082114.md` — that routing satisfies the pre-PLAN owner/consumer acknowledgment gate named on both sides (must-revise M1; consistency correction, review 081432).
Harness amendment 1 (recovery-event association, single-fault recovery/log ordering) is harness-owned, out of engine scope, and changes none of the engine-facing shapes or obligations below.
...
Reads: harness protocol schema v1 — the APPROVED owner record DD-harness-c1-20260825 @ digest c935c29c0ee603df1750c49c40dabcd5432f70105070b60552728f1e6dc24a6e, amendment 1 included (consumer, as-is; concrete adapter acknowledgment orchestrator-routed pre-PLAN); theory fixture schema v1 (consumer, verbatim); theory findings doc (gates the successor DD, not this one).
