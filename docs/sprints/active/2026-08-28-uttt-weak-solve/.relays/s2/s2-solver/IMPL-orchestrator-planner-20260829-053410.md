...
SUBJECT: IMPL dispatch — solver-c3 proof-engine bundle under PL-solver-c3-20260829 rev4 (supersedes impl-1, token-in-subject lint defect)

## Implementation dispatch (orchestrator direct; supersedes s2-solver-c3-impl-1, whose relay is structurally dirty — the token appeared inline in its SUBJECT and grants nothing)
