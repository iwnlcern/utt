...
IN_REPLY_TO: s2-theory/REVIEW-FOLD-pair-planner-20260830-034814.md
...
SUBJECT: REVIEW-FOLD report — theory-c3 MF-1 and directed optionals at PR #13 head 675ef22
...
FOLD_SCOPE:
- theory/checker/src/verify.c3 -> in (MF-1 path fault handling and dead-counter cleanup)
- theory/checker/README.md -> in (directed contract clarifications)
- theory/tests/test_checker_battery.py -> in (MF-1 and long-digest regression coverage)
- theory/certschema/vectors.py -> in (emitter-side long-digest probe helper)
FOLD_SCOPE_RESULT: all-in

The scope artifact was written before the first repository edit at `/tmp/uttt-s2-theory-c3-fold-1-scope.md`, SHA-256 `07e18a29e98a73d3b3292159bc0e4dbb6716dd125b451b2185311cfe1f90ac45`. The committed diff touches exactly the four all-in rows above.
...
FINAL_GIT_STATUS_SHORT: clean in the isolated feature worktree; shared coordination checkout retains only the pre-existing `.claude/scheduled_tasks.lock` modification before filing
